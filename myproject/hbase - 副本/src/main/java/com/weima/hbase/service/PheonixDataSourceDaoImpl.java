...
public class PheonixDataSourceDaoImpl implements PheonixDataSourceDao {
     ...
     */
    @Override
    public List<PheonixResult> Query(String sql) throws Exception{
        Gson gson = new Gson();
        int i = 1;
...
//                pheonixResult.setMappingItems(JSONObject.parseObject(rs.getString("mappingItems")));
    ...
    @Override
    public Integer QueryTotalNum(String sql) throws Exception{
