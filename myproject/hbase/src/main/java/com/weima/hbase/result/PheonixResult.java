...
public class PheonixResult {
    ...
    public PheonixResult() {
    }

    public PheonixResult(String iccid, String vin, Boolean reissue, String tboxVersion, BigInteger tboxTime, String version, BigInteger parseTime, JSONObject items, JSONObject mappingItems) {
        this.iccid = iccid;
        this.vin = vin;
